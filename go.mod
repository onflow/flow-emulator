...
require (
	github.com/dapperlabs/flow-go v0.3.2-0.20200506201433-d8d7f8a9b259
	...
	github.com/onflow/cadence v0.2.1
	github.com/onflow/flow-go-sdk v0.1.2-0.20200506234646-8b2246384805
