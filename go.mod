...
replace github.com/onflow/flow-go v0.37.7-0.20240830182756-9ac9e1889c34 => github.com/AndriiDiachuk/flow-go v0.34.0-crescendo-preview.15-atree-inlining.0.20240903134606-a4a4cefea99c
