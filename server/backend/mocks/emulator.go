...
func (m *MockEmulator) CreateAccount(arg0 []*flow_go_sdk.AccountKey, arg1 []templates.Contract) (flow_go_sdk.Address, error) {
	m.ctrl.T.Helper()
...
func (m *MockEmulator) GetLatestBlockID() (flow_go_sdk.Identifier, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestBlockID")
	ret0, _ := ret[0].(flow_go_sdk.Identifier)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLatestBlockID indicates an expected call of GetLatestBlockID
func (mr *MockEmulatorMockRecorder) GetLatestBlockID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLatestBlockID", reflect.TypeOf((*MockEmulator)(nil).GetLatestBlockID))
}
