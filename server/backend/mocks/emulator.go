...
func (m *MockEmulator) GetAccountByIndex(arg0 uint) (*flow_go_sdk.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockEmulator) GetAccountUnsafe(arg0 flow_go_sdk.Address) (*flow_go_sdk.Account, error) {
	m.ctrl.T.Helper()
